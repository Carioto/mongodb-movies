...
query getmovieswithparams($year:Int!,$language:String,$genre:String,$searchwords:String){
movieswithparams(year:$year,languages:$language,genres:$genre,searchwords:$searchwords){
_id
title
plot
year
